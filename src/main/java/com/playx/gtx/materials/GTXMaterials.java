...
import com.playx.gtx.fission.FluidNuclearComponent;
...
public class GTXMaterials {
    ...
    public static final MaterialFlag GENERATE_NUCLEAR_FUEL = new MaterialFlag.Builder("generate_nuclear_fuel").requireProps(PropertyKey.INGOT).build();
    ...
    public static final MaterialFlag GENERATE_NUCLEAR_ABSORBABLE = new MaterialFlag.Builder("generate_nuclear_absorbable").requireProps(PropertyKey.INGOT).build();
    ...
    public static final RadioactiveMaterial UraniumRadioactive = new RadioactiveMaterial("uranium_radioactive", GTMaterials.Uranium238.getMaterialRGB(), MaterialIconSet.METALLIC, 3, of(), (List<MaterialFlag>) ext2Metal(GENERATE_ORE, GENERATE_FRAME), GTElements.U, 0, 0, 0, 0);
    // Uranium
    ...
    public static final IsotopeMaterial Plutonium244Isotope = new IsotopeMaterial(GTMaterials.Plutonium239, RadioactiveMaterial.REGISTRY.get(PlutoniumRadioactive.getMaterial()), 244);
    ...
    public static final Material Fluorobeznene = new Material.Builder(GTXMod.id("fluorobenzene"))
            .color((Carbon.getMaterialRGB() + Hydrogen.getMaterialRGB() + Fluorine.getMaterialRGB()) / 3)
            .liquid()
    ...
    public static Material HeavyWater = new Material.Builder(GTXMod.id("heavy_water"))
            .color((Oxygen.getMaterialRGB() + Deuterium.getMaterialRGB()) / 2)
    ...
    static {
        RadioactiveMaterial.REGISTRY.forEach((material, radioactiveMaterial) -> {
            GTXMod.LOGGER.info("Registering " + material.getName() + " fluids");
            radioactiveMaterial.fluidHexachloride = new Material.Builder(GTXMod.id(material.getName() + "_hexachloride"))
                    .color((material.getMaterialRGB() + Chlorine.getMaterialRGB()) / 2)
                    .fluid()
                    .components(material, 1, Chlorine, 6)
                    .iconSet(MaterialIconSet.DULL)
                    .buildAndRegister();

            radioactiveMaterial.fluidHexafluoride = new Material.Builder(GTXMod.id(material.getName() + "_hexafluoride"))
                    .color((material.getMaterialRGB() + Fluorine.getMaterialRGB()) / 2)
                    .fluid()
                    .components(material, 1, Fluorine, 6)
                    .iconSet(MaterialIconSet.DULL)
                    .buildAndRegister();
        });

        IsotopeMaterial.REGISTRY.forEach((material, isotopeMaterial) -> {
            GTXMod.LOGGER.info("Registering " + material.getName() + " fluids");
            isotopeMaterial.fluidHexafluoride = new Material.Builder(GTXMod.id(material.getName() + "_isotope_" + "_hexafluoride"))
                    .color((material.getMaterialRGB() + Fluorine.getMaterialRGB()) / 2)
                    .fluid()
                    .components(material, 1, Fluorine, 6)
                    .iconSet(MaterialIconSet.DULL)
            ...
            isotopeMaterial.depletedFuelNitrateSolution = new Material.Builder(GTXMod.id(material.getName() + "_isotope_depleted_fuel_nitrate_solution"))
                    .color((material.getMaterialRGB() + NitricAcid.getMaterialRGB()) / 2)
                    .fluid()
                    .components(material, 1, NitricAcid, 1)
                    .iconSet(MaterialIconSet.DULL)
                    .buildAndRegister();

            isotopeMaterial.hexafluorideSteamCracked = new Material.Builder(GTXMod.id(material.getName() + "_isotope_hexafluoride_steam_cracked"))
                    .color((material.getMaterialRGB() + Fluorine.getMaterialRGB()) / 2)
                    .fluid()
                    .components(material, 1, Fluorine, 6)
                    .iconSet(MaterialIconSet.DULL)
    ...
    public static final Map<Material, Material> HOT_FLUIDS = new HashMap<>();


    public static void init() {
        GoldChain.init();
        LithiumChain.init();
        GTXItems.initNuclearWaste();
    ...
    public static void modifyMaterials() {
        ...
        GTMaterials.Protactinium.addFlags(MaterialFlags.GENERATE_FRAME, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Neptunium.addFlags(MaterialFlags.GENERATE_FRAME, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Curium.addFlags(MaterialFlags.GENERATE_FRAME, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Berkelium.addFlags(MaterialFlags.GENERATE_FRAME, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Californium.addFlags(MaterialFlags.GENERATE_FRAME, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Einsteinium.addFlags(MaterialFlags.GENERATE_FRAME, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Fermium.addFlags(MaterialFlags.GENERATE_FRAME, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Mendelevium.addFlags(MaterialFlags.GENERATE_FRAME, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Thallium.addFlags(MaterialFlags.GENERATE_FOIL, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Germanium.addFlags(MaterialFlags.GENERATE_PLATE, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Seaborgium.addFlags(MaterialFlags.GENERATE_FRAME, GENERATE_PLATE, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        GTMaterials.Bohrium.addFlags(MaterialFlags.GENERATE_FRAME, MaterialFlags.GENERATE_ROUND, MaterialFlags.GENERATE_PLATE);
        Stellite100.addFlags(GENERATE_FRAME, GENERATE_GEAR, GENERATE_METAL_CASING, GENERATE_SMALL_GEAR);
        ...
        Thorium.addFlags(GENERATE_LONG_ROD);
        Uranium235.addFlags(GENERATE_LONG_ROD);
        ...
        //Uranium
        UraniumRadioactive.composition.put(Uranium238Isotope.getMaterial(), 9890);
        UraniumRadioactive.composition.put(Uranium235Isotope.getMaterial(), 100);
        UraniumRadioactive.composition.put(Uranium234.getMaterial(), 10);

        Uranium233.setFissile();
        Uranium235Isotope.setFissile();
        ...
        //neptunium
        Neptunium.composition.put(Neptunium235.getMaterial(), 2000);
        Neptunium.composition.put(Neptunium237.getMaterial(), 5000);
        Neptunium.composition.put(Neptunium239.getMaterial(), 3000);

        Neptunium237.setFissile();
        ...
        //plutonium
        PlutoniumRadioactive.composition.put(Plutonium244Isotope.getMaterial(), 9890);
        PlutoniumRadioactive.composition.put(Plutonium241Isotope.getMaterial(), 100);
        PlutoniumRadioactive.composition.put(Plutonium240.getMaterial(), 10);

        Plutonium241Isotope.setFissile();
        Plutonium239.setFissile();
        ...
        //Americium
        AmericiumRadioactive.composition.put(Americium241.getMaterial(), 2000);
        AmericiumRadioactive.composition.put(Americium243.getMaterial(), 5000);
        AmericiumRadioactive.composition.put(Americium245.getMaterial(), 3000);

        Americium243.setFissile();
        ...
        //Curium
        Curium.composition.put(Curium250.getMaterial(), 9890);
        Curium.composition.put(Curium247.getMaterial(), 100);
        Curium.composition.put(Curium246.getMaterial(), 10);

        Curium245.setFissile();
        Curium247.setFissile();
        ...
        //Berkelium
        Berkelium.composition.put(Berkelium247.getMaterial(), 2000);
        Berkelium.composition.put(Berkelium249.getMaterial(), 5000);
        Berkelium.composition.put(Berkelium251.getMaterial(), 3000);

        Berkelium249.setFissile();
        ...
        //Californium
        Californium.composition.put(Californium252.getMaterial(), 9890);
        Californium.composition.put(Californium253.getMaterial(), 100);
        Californium.composition.put(Californium256.getMaterial(), 10);

        Californium251.setFissile();
        Californium253.setFissile();
        ...
        //Einsteinium
        Einsteinium.composition.put(Einsteinium253.getMaterial(), 2000);
        Einsteinium.composition.put(Einsteinium255.getMaterial(), 5000);
        Einsteinium.composition.put(Einsteinium257.getMaterial(), 3000);

        Einsteinium255.setFissile();
        ...
        //Fermium
        Fermium.composition.put(Fermium258.getMaterial(), 9890);
        Fermium.composition.put(Fermium259.getMaterial(), 100);
        Fermium.composition.put(Fermium262.getMaterial(), 10);

        Fermium257.setFissile();
        Fermium259.setFissile();
        ...
        //Mendelevium
        Mendelevium.composition.put(Mendelevium259.getMaterial(), 2000);
        Mendelevium.composition.put(Mendelevium261.getMaterial(), 5000);
        Mendelevium.composition.put(Mendelevium263.getMaterial(), 3000);

        Mendelevium261.setFissile();
        ...
        Invar.addFlags(GENERATE_NUCLEAR_ABSORBABLE);
